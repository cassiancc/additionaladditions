...
public class AdditionalMusicDiscs {
    ...
    public static final Item MUSIC_DISC_0308 = new AdditionalMusicDiscItem(15, SOUND_EVENT_0308, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 83);
    public static final Item MUSIC_DISC_1007 = new AdditionalMusicDiscItem(15, SOUND_EVENT_1007, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 102);
    public static final Item MUSIC_DISC_1507 = new AdditionalMusicDiscItem(15, SOUND_EVENT_1507, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 214);

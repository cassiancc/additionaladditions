...
public class AdditionalEntities {
    ...
    public static void registerAll() {
        Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(AdditionalAdditions.namespace, "glow_stick"), GLOW_STICK_ENTITY_ENTITY_TYPE);
    }
}
